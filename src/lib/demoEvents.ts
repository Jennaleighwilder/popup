...
export const DEMO_EVENTS: Record<string, EventData> = {
  ...
  "morning-rituals": {
    ...
    journey: [
      ...
      { step: "Sound Bath", desc: "A sound bath follows. Crystal singing bowls tuned to the chakras fill the space as you rest in savasana.", image: "https://images.unsplash.com/photo-1591228127121-c36daa62ee22?w=600&h=400&fit=crop" },
