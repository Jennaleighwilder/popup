...
export const DEMO_EVENTS: Record<string, EventData> = {
  ...
  "first-friday-art-walk": {
    ...
    venueImage: "https://images.unsplash.com/photo-1536924940846-227afb31e2a5?w=1920&h=800&fit=crop",
    highlights: [
    ...
    featuredWorks: [
      { title: "Convergence", desc: "Mixed media on canvas — by Sarah Whitfield" },
      { title: "Appalachian Light", desc: "Oil on linen — by Thomas Crow" },
      { title: "Vessel Series", desc: "Hand-thrown stoneware — by Keiko Matsuda" },
    ],
  ...
  "morning-rituals": {
    ...
    venueImage: "https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=1920&h=800&fit=crop",
    highlights: [
    ...
    hosts: [
      {
        ...
        image: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=400&h=400&fit=crop&crop=face",
      },
    ],
    schedule: [],
    journey: [
      { step: "Arrival", desc: "We begin in stillness. As the desert sun rises, we gather in a circle for opening breathwork — a gentle pranayama practice to arrive fully in our bodies." },
      { step: "Movement", desc: "We move into a slow, intentional vinyasa flow. This isn't a workout — it's a conversation with your body. All levels welcome." },
      { step: "Sound Bath", desc: "A sound bath follows. Crystal singing bowls tuned to the chakras fill the space as you rest in savasana." },
      { step: "Cacao & Intention", desc: "We close with a cacao ceremony and journaling. Hot ceremonial cacao, a writing prompt, and space to set an intention for the month ahead." },
      { step: "Breakfast", desc: "We share a light breakfast together — fresh fruit, granola, herbal tea — as the morning warmth settles in." },
    ],
    whatToBring: ["Yoga mat", "Water bottle", "Journal", "Layers (desert mornings are cool)", "Sunscreen", "An open heart"],
    whatsProvided: ["Ceremonial cacao", "Light breakfast", "Blankets and props", "Sound healing instruments", "All materials for journaling"],
    testimonials: [
      { quote: "I've done retreats all over the world, and this was the most grounding experience I've ever had.", author: "— Maya, Los Angeles" },
      { quote: "Aria creates a space where you feel safe to let go completely.", author: "— James, San Francisco" },
    ],
    tickets: [
  ...
  "golden-hour-sessions": {
    ...
    highlights: [
      { title: "Vinyl Only", desc: "Rare groove, Brazilian jazz, Balearic, and beyond" },
      { title: "Sunset Views", desc: "DTLA skyline as the golden hour fades" },
      { title: "Two DJs", desc: "DJ Soleil and Kenji Tanaka, plus a B2B closing set" },
    ],
    hosts: [
      {
        name: "DJ Soleil",
        role: "Vinyl Selector",
        bio: "Vinyl-only selector. Genres: rare groove, Brazilian jazz, Balearic. Resident at Love International.",
        image: "https://images.unsplash.com/photo-1571330735066-03aaa9429d89?w=400&h=400&fit=crop&crop=face",
      },
      {
        name: "Kenji Tanaka",
        role: "Producer & DJ",
        bio: "Producer and DJ. Releases on Stones Throw and Brainfeeder. Known for dusty beats and warm basslines.",
